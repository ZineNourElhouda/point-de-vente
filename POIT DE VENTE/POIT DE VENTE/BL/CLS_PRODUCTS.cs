...
namespace POIT_DE_VENTE.BL
{
    class CLS_PRODUCTS
    {
        ...
        public void ADD_PRODUCT(int ID_cat, string Label_product, string ID_product, int Qte, string Price, byte[] Image_Product)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.Open();
            ...
            DAL.ExecuteCommed("ADD_PRODUCT", param);
            DAL.Close();
        }


        public void UPDATE_PRODUCT(int ID_cat, string Label_product, string ID_product, int Qte, string Price, byte[] Image_Product)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.Open();
            SqlParameter[] param = new SqlParameter[6];
            ...
            DAL.ExecuteCommed("UPDATE_PRODUCT", param);
            DAL.Close();
        }
        ...
        public void DeleteProduct(string ID)
        {
            ...
            param[0] = new SqlParameter("@ID", SqlDbType.NVarChar, 50);
            param[0].Value = ID;
            DAL.ExecuteCommed("DeleteProduct", param);
            DAL.Close();
        }
    }
}
